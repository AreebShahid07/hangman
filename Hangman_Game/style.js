...
const worddisp = document.querySelector(".words");
...
const resetGame = () => {
    ...
    hangmanimg.src = `hangman-${wrongcount}.png`;
    guessestext.innerText = `${wrongcount} / ${maxguess}`;
    keyb.querySelectorAll("button").forEach(btn => btn.disabled = false);
...
const gameover = (isVictory) => {
    setTimeout(() => {
        const modaltext = isVictory ? `Yayyy!!! You guessed the word: ` : `The correct word was:`;
...
const initGame = (button, clickedLetter) => {
    ...
    if (wrongcount === maxguess) return gameover(false);
